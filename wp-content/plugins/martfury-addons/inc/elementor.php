...
class Elementor {
	...
	public function init_widgets() {
		...
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Products_Brands() );
		...
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Banner_Large_2() );
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Banner_App() );
		...
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Brand_Images() );
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Brand_Images_Carousel() );
		...
		$widgets_manager->register_widget_type( new \MartfuryAddons\Elementor\Widgets\Testimonial_Slides_2() );
