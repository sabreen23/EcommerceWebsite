...
class APPMAKER_WC_Third_party_support {
	static function init() {
		...
		//https://docs.woocommerce.com/document/buy-one-get-one-free/
		if ( class_exists( 'WC_Buy_One_Get_One_Free' ) && ! class_exists('APPMAKER_WC_Buy_One_Get_One_Free') ) {
			require 'misc/class-appmaker-wc-buy-one-get-one-free.php';
		}

		//https://wordpress.org/plugins/ajax-search-for-woocommerce/ - fibosearch
		if ( class_exists( 'DGWT_WC_Ajax_Search' ) && ! class_exists('APPMAKER_WC_FIBOSEARCH') ) {
			require 'misc/class-appmaker-wc-fibosearch.php';
		}
