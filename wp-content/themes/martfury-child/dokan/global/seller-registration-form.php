...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
	...
	<p class="form-row form-group form-row-wide">
		<label for="company-name"><?php esc_html_e( 'Shop Name / Name by which you want to sell', 'martfury' ); ?>
			<span class="required">*</span></label>
...
**/?>
	<p class="form-row form-group form-row-wide">
		<label for="shop-phone"><?php esc_html_e( 'Phone Number', 'martfury' ); ?>
			<span class="required">*</span></label>
		<input type="number" class="input-text form-control" name="phone" id="shop-phone" value="<?php if ( ! empty( $postdata['phone'] ) ) {
...
<p class="form-row form-group user-role">
	...
	<label class="radio woocommerce-form__label-for-checkbox">
		...
		<span>
       	 <?php esc_html_e( 'I am a seller', 'martfury' ); ?>
		</span>
	</label>
