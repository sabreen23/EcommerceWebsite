...
class APPMAKER_WC_REST_Orders_Controller extends APPMAKER_WC_REST_Posts_Abstract_Controller {
	...
	public function get_item_permissions_check( $request ) {
		...
		if ( true === $api_check ) {
			...
			if( ! APPMAKER_WC::$api->get_settings( 'use_order_number', true ) && class_exists( 'WC_Seq_Order_Number' ) ) {
				$order_id = WC_Seq_Order_Number::instance()->find_order_by_order_number( (int) $request['id'] );
