...
class Advanced_Visit_Counter_Admin extends Advanced_Visit_Counter_Queries
{
    ...
    {
        global  $wpdb ;
        $opt = get_option( 'apvc_notice' );
        if ( isset( $_GET['page'] ) && $_GET['page'] === 'apvc-dashboard-page' && $opt == 'no' ) {
            ?>
			<div class="container-fluid">
			    <div class="container">
				      <div class="content-wrapper">
				        <div class="row">
				        	<div class="col-lg-12" style="margin: 25px; border: red solid 2px; padding: 10px;">
				        		<span style="color: red; font-weight: bold;">New: 5.0.3</span><span>   Anonymize the IP address for GDPR Compliance. Go to <strong>Settings / Advanced Settings</strong></span>
				        		<button id="update_clear" style="border: none;width:25px; border-radius: 45px; background: red; color: white;">X</button>
				        	</div>
				        </div>
				    </div>
				</div>
    ...
    public function apvc_reports_settings_page()
    {
        ...
        ?></label>
					            	...
					            	<div class="col-md-6">
			                        	<div class="form-group">
				                          <div class="card-body">
				                          	<label><?php 
        echo  __( "Enable Anonymize IP", "apvc" ) ;
        ?></label>
					                        <div class="icheck-square">
					                          <input tabindex="6" type="checkbox" name="ip_anonymize" <?php 
        if ( $avc_config->ip_anonymize[0] == "on" ) {
            echo  "checked" ;
        }
        ?>><label><?php 
        _e( "Yes", "apvc" );
        ...
        echo  __( "Anonymize the IP address for GDPR Compliance", "apvc" ) ;
        ?></small>
					                        <small class="text-muted" style="color: red !important;">***.***.***.***</small>
					                      </div>
					                	</div>
					            	</div>
