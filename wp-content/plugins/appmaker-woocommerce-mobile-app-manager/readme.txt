...
Tags: WooCommerce mobile app builder, WooCommerce to android app, convert WooCommerce to mobile app, WooCommerce app builder, WooCommerce to mobile app, WooCommerce app maker, Create WooCommerce app, Mobile app builder for WooCommerce
...
== Description ==
### CREATE WooCommerce APPS WITH APPMAKER WooCommerce APP PLUGIN ###
- _Convert WooCommerce to mobile app and grow your Business._
- _Build your app with the #1 WooCommerce app maker tool._
- _Easily drag and drop WooCommerce app builder._
- _Position your brand with a beautifully designed WooCommerce mobile app._
- _Try the DIY WooCommerce mobile app builder._
- _Re-engage your customers by sending unlimited personalized push notifications._
- _Increase sales with an easy checkout procedure._
- _Get an eCommerce app that is synced with your WooCommerce website._

[Appmaker](https://appmaker.xyz/woocommerce?utm_source=wordpress-org&utm_medium=referral) is preferred by 5000+ brands when they are transforming from WooCommerce to an android app or iOS apps. Creating a mobile app usually requires profound coding and technical knowledge. With Appmaker no-code [mobile app builder](https://appmaker.xyz?utm_source=wordpress-org&utm_medium=referral) you can easily convert your e-commerce store into a mobile app without technical dependency. Here is a glance at "how you can build your mobile app within minutes":

https://www.youtube.com/watch?v=Og9FGnnNUok&t=50s
...
- Integrate with 100+ [WooCommerce plugins](https://appmaker.xyz/en/woocommerce/plugins-supported/?utm_source=wordpress-org&utm_medium=referral)
- Easy Integration with top Payment gateways
- Customize App via drag and drop builder
- Increase conversion rates with [push notifications](https://appmaker.xyz/push-notification-for-e-commerce-apps?utm_source=wordpress-org&utm_medium=referral)
- Multilingual and multi-currency support
- Simplify Checkout Process with [Apple Pay](https://appmaker.xyz/woocommerce/features/apple-pay?utm_source=wordpress-org&utm_medium=referral)
- Real-time App UI customization
- Enhance customer experience with [Mobile OTP Login](https://blog.appmaker.xyz/otp-based-login-how-appmakers-feature-maximizes-user-retention/?utm_source=wordpress-org&utm_medium=referral)
- Connect to customers using Live Chat Support
- WooCommerce Social Logins ( Google login, [Apple login](https://appmaker.xyz/woocommerce/features/apple-login?utm_source=wordpress-org&utm_medium=referral) )
- Product filtering and sorting
- Order tracking
- Easy Product shipping
- Bundle, cross-sell and up-sell
- WooCommerce multi-vendor marketplace support
- Fully compatible with [WPML](https://wpml.org/plugin/appmaker-wp/)


#### POPULAR BRAND’S USING OUR WOOCOMMERCE MOBILE APP BUILDER PLUGIN

**Miiriya**( [Android](https://play.google.com/store/apps/details?id=com.miiriya.app&hl=en&gl=US)/[iOS](https://apps.apple.com/us/app/miiriya/id1524930388)) ★★★★★2000+ Ratings, 50K+ Downloads
**Andjoy**([Android](https://play.google.com/store/apps/details?id=com.gymforless&hl=en_IN&gl=US)/[iOS](https://apps.apple.com/us/app/andjoy/id774774395)) ★★★★★ 2000+ Ratings, 100K+ Downloads
**Decor Essentials**([Android](https://play.google.com/store/apps/details?id=com.coffye.decoressentials&hl=en_IN&gl=US))  ★★★★★ 100+ Ratings, 10K+ Downloads
...
**Underground reptiles** ([Android](https://play.google.com/store/apps/details?id=com.underground.reptiles))  ★★★★★ 300+ Ratings, 10K+ Downloads

Know more about us, Appmaker is featured on [Yourstory](https://yourstory.com/2019/02/startupbharat-kochi-appmaker-app-builder), [Android Authority](https://www.androidauthority.com/pwa2apk-tool-953792/), [Product Hunt](https://www.producthunt.com/posts/web2desk), [Business Bloomer](https://businessbloomer.com/create-woocommerce-ios-android-app/), [LifeHacker](https://lifehacker.com/turn-your-favorite-website-into-a-desktop-app-1827807804).


Visit [Appmaker Blog](https://blog.appmaker.xyz/?utm_source=wordpress-plugin?utm_source=wordpress-org&utm_medium=referral) to get helpful insights about M-Commerce. If you are getting started with mobile app building: [access the Complete Guide to WooCommerce Mobile App Creation](https://blog.appmaker.xyz/a-complete-guide-to-woocommerce-mobile-app-creation/?utm_source=wordpress-org&utm_medium=referral)
...
- _Nowadays people ignore promotional emails and may even report them as spam. Push Notifications that are sent from the Mobile apps have shown 10 times more open rates than Email Marketing Campaigns._
...
We help businesses from all [industries](https://appmaker.xyz/woocommerce/industries?utm_source=wordpress-org&utm_medium=referral) to make apps for their website with minimum effort. Let’s get started, [convert your WooCommerce store to a native mobile app now](https://appmaker.xyz/woocommerce?utm_source=wordpress-org&utm_medium=referral).


**Support**

Got any questions about WooCommerce app building? Email us at [support@appmaker.xyz](mailto:support@appmaker.xyz).
...
2. Copy and paste API Key and API Secret from your dashboard into Appmaker plugin settings.
3. Once the store is synced with Appmaker, you can design it accordingly.
...
- You can easily publish and update WooCommerce Android App to Google Play Store from Appmaker dashboard. 

- You can easily publish and update WooCommerce iOS App to iTunes App Store from Appmaker dashboard.

= What if I am facing an issue(bug) in WooCommerce App ? =

You can always reach out to us through intercom or create a ticket at https://appmaker.xyz/user/support?utm_source=wordpress-org&utm_medium=referral.
...
We have been in the industry for 5 years and have witnessed sales skyrocket when WooCommerce stores opted for productive mobile apps that appmaker provide.. Additionally, we have an App growth team in place to help you in leveraging mobile app for your store.

= How do I get to you? =

You can reach us at support@appmaker.xyz as well as on all Social Media channels. [Twitter](https://twitter.com/appmaker_xyz), [Facebook](https://www.facebook.com/appmaker.xyz/), [Instagram](https://www.instagram.com/appmaker.xyz/), [Youtube](https://www.youtube.com/channel/UCYpPbibUUkhxA79dk215DdQ).
...
You can read about plugins we support [here](https://appmaker.xyz/en/woocommerce/plugins-supported/?utm_source=wordpress-org&utm_medium=referral), not on the list? Get in touch with our team.
== Changelog ==
...
* WooCommerce Plugin: Compatible with WCFM plugin 6.6.1 
* Fawry payment gateway thanku page redirect fix
* Login/Signup popup plugin redirection fixes
* WooCommerce Plugin: WC sequential order plugin fix
* WooCommerce Plugin: yith points and rewards premium conflict fix
* WooCommerce Plugin: WC brands product filter fix
* WooCommerce Plugin: WC buy one get one free plugin support
* Compatible with WC 5.9


= 1.35.9 =

Updated Date: 26/10/21

* Backorder products visibility issue fix
* MiniOrange OTP plugin redirect to app fixes
* Added sorting to WCFM vendor list
* Added Appmaker settings configuration success UI
* WooCommerce Plugin: Woocommerce check pincode/zipcode for shipping and COD plugin free version support added
* WooCommerce Plugin: Improved sale badges plugin compatibility issues fixed
* Compatible with WC 5.8

= 1.35.8 =

Updated Date: 21/09/21

* WC Repeat order bug fixes
* Added translation for including tax string
* WCFM product widgets rearrangment issues fixed
* WooCommerce Plugin: Woocommerce check pincode/zipcode for shipping and COD plugin : added pincode save for guest users

= 1.35.6 =

Updated Date: 06/09/21

* WooCommerce Plugin: WC cancel order plugin compatibility issues fixed
* WooCommerce Plugin: WooCommerce bundle products delete button issue fix
* WooCommerce Plugin: WooCommerce bundle products price fix in product list
* WooCommerce Plugin: WPML attribute translations support added
* WooCommerce Plugin: PPOM plugin compatibility issues fixed

= 1.35.5 =

Updated Date: 16/08/21

* WooCommerce Plugin: WC vendors- add/remove seller tab from  single product page
* WooCommerce Plugin: Dokan vendor vacation product display fix
* Firebase login error message fixes

= 1.35.4 =

Updated Date: 04/08/21

* Fixed compatibility issues with WordPress 5.8

= 1.35.3 =

Updated Date: 30/07/21

* Fixed compatibility issues with PHP 8.0
* Wishlist issue fix for new user registerations
* Webview login redirection fix for easy login woocommerce plugin

= 1.35.2 =

Updated Date: 08/07/21

* Loco translate plugin translation fixes on checkout
* view more reviews button addition
* Added settings to hide product rating 
* YITH WooCommerce Wishlist  plugin bug fixes

= 1.35.1 =

Updated Date: 15/06/21

* WooCommerce Plugin: Yith Product brands bug fixes
* WooCommerce Plugin : WC subscriptions plugin price conflict fix
* Resolved conflicts with digits plugin on login in webview
* YITH WooCommerce Wishlist Premium plugin bug fixes

= 1.35.0 =

Updated Date: 18/05/21

* WooCommerce Plugin: Wholesale price plugin pro cart conflict fix 
* WooCommerce Plugin : YITH WooCommerce Wishlist Premium plugin support

= 1.34.11 =

Updated Date: 07/05/21

* WooCommerce: Push notification for customer order notes
* WooCommerce Plugin: Automate Woo push notfication fixes
* Sub-orders in orders list fixes

= 1.34.10 =

Updated Date: 04/05/21
...
Updated Date: 09/02/21

* Cart items deletion/Updated issue fix
...
Updated Date: 13/1/21

* Minor bug fixes

= 1.34.0 =

Updated Date: 12/1/21

* Feature: appmaker multi step checkout

= 1.33.3 =

Updated Date: 07/1/21
...
Updated Date: 16/05/20

* WPML plugin  fix

= 1.27.2 =

Updated Date: 15/05/20

* Minor fixes

= 1.27.1 =

Updated Date: 14/05/20
...
Updated Date: 17/04/20

* Home page issue fix

= 1.25.5 =

Updated Date: 16/04/20
...
Updated Date: 11/04/20

* Added app download widget support

= 1.25.2 =

Updated Date: 09/04/20
...
* WooCommerce plugin: Order delivery date pro plugin Updated
...
Updated Date: 02/03/20

* Plugin page fixes

= 1.22.3 =

Updated Date: 26/02/20

* In-app page fix

= 1.22.2 =

Updated Date: 25/02/20

* WooCommerce plugin: Sumopayment Updated


= 1.22.1 =

Updated Date: 19/02/20
...
Updated Date: 10/01/20

* Minor bug fixes

= 1.19.3 =

Updated Date: 09/01/20
...
Updated Date: 07/01/20

* Minor bug fixes

= 1.19.0 =

Updated Date: 06/01/20
...
Updated Date: 20/11/19

* App category filter fix

= 1.17.0 =

Updated Date: 18/11/19
...
Updated Date: 19/10/19

* Fixed minor issues on coupon discount

= 1.16.2 =

Updated Date: 10/10/19
