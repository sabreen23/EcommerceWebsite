...
jQuery(document).ready(function($) {
	...
	$(themexElements.page).find('input[type="submit"]').on('click', function() {
	...
	//Buttons
	$(themexElements.page).find('input, select').on('change', function(){
	...
	$('body').on('click', themexElements.buttonAdd, function() {
		var button=$(this);
		var data = {
	...
	$('body').on('click', themexElements.buttonRemove, function() {
		var button=$(this);
	...
	$('body').on('click', themexElements.buttonClone, function() {
		var button=$(this),
	...
	$(themexElements.tabsContainer).each(function() {
		...
		tabsContainer.find(themexElements.tabsList).find('a').click(function() {
	...
	$('body').on('click', themexElements.buttonUpload, function(e) {
