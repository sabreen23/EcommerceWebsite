...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210902_swiddly_f6b29441cb8659608274_20210902172328_archive.zip';
	const ARCHIVE_SIZE		 = '594798';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f6b2944-02172328';
    const SECONDARY_PACKAGE_HASH = '4cd839d-02172328';
	const VERSION			 = '1.4.2';
